...
PUBLIC	??_C@_0M@HADCBKP@May?518?52022@			; `string'
...
CONST	ENDS
;	COMDAT ??_C@_0M@HADCBKP@May?518?52022@
CONST	SEGMENT
??_C@_0M@HADCBKP@May?518?52022@ DB 'May 18 2022', 00H	; `string'
CONST	ENDS
...
; File E:\学习\计网\Lab1-2022(Win+Linux)\Lab1-2022(Win+Linux)\Lab1-Windows-VS2019\protocol.c
;	COMDAT randB
_TEXT	SEGMENT
randB	PROC						; COMDAT
...
; 627  : {
	...
	lea	rcx, OFFSET FLAT:__FA3566D8_protocol@c
...
; 243  : 	lprintf("Protocol.lib, version %s, jiangyanjun0718@bupt.edu.cn\n", VERSION, __DATE__);
	...
	lea	r8, OFFSET FLAT:??_C@_0M@HADCBKP@May?518?52022@
